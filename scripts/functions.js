...
endpoint.userGet = function (url) {
    var options = checkHttpOptions(url, {});
    return endpoint._userGet(options);
};

endpoint.userPost = function (url, options, callbackData, callbacks) {
    options = checkHttpOptions(url, options);
    return endpoint._userPost(options, callbackData, callbacks);
};
...
endpoint.userPut = function (url, options) {
    options = checkHttpOptions(url, options);
    return endpoint._userPut(options);
};

endpoint.userDelete = function (url) {
    var options = checkHttpOptions(url, {});
